...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*🖥️DOM ELEMENTS*/ const map = document.getElementById("map");
...
/*🖥️DELEGATION*/ if (map) {
    ...
    /*we need JSON parse here because we stringified tour.json.locations in tour.pug*/ (0, _leaflet.displayMap)(locations);
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (userPasswordForm) userPasswordForm.addEventListener("submit", async (e)=>{
    ...
    /*we await here in order to open the possibility to do another stuff with the settings before save - in this case we will clear the password forms*/ document.querySelector(".btn--save-password").textContent = "Save password";
...
if (bookBtn) bookBtn.addEventListener("click", (e)=>{
    ...
    /*The dataset read-only property of the HTMLElement interface provides read/write access to custom data attributes (data-*) on elements. It exposes a map of strings (DOMStringMap) with an entry for each data-* attribute. Here the book button is the target*/ const { tourId  } = e.target.dataset;
    (0, _stripe.bookTour)(tourId);
});

},{"./leaflet":"xvuTT","./login":"7yHem","./signup":"fNY2o","./updateSettings":"l3cGY","./stripe":"10tSC"}],"xvuTT":[function(require,module,exports) {
...
const logout = async ()=>{
    try {
        ...
        //if (res.data.status === "success") location.reload(true); /*it forces a server reload, not browser cache reload*/
...
const updateSettings = async (data, type)=>{
    /*type is either password, or data*/ try {
...
const bookTour = async (tourId)=>{
    const stripe = Stripe("pk_test_51M0tDyGDbpf0yVaRzV66YaAYzPz3IHNSoVRNAsUzroTGBhddk2Q4q2rq7wPnr2XVgxmqJuXCrHiHH8JyByIWnToC006uTGDrMP");
    try {
        /*🗃️ Get checkout session from API*/ const session = await (0, _axiosDefault.default)(`http://127.0.0.1:3000/api/v1/bookings/checkout-session/${tourId}`);
        console.log(session);
        /*🗃️ Create checkout form + chanre credit card*/ await stripe.redirectToCheckout({
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f2QDv"], "f2QDv", "parcelRequirebd66")
